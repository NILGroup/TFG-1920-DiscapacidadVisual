 ...
 * edificio. Cada cuadrante tendrá un identificador ID, un valor que indicará su planta Z, dos atributos
 * de tipo Posicion que indicarán las esquinas opuestas del cuadrante PosNW y posSE, un array de String
 * que indicarán el ID del cuadrante con el que esté conectado según el esquema indicado y un ArrayList
 * de String que contendrán los objetos identificativos del cuadrante.
 * 
...
public class Cuadrante {
	...
	public Cuadrante(int id, Posicion nw, Posicion se, int z, String[] conexiones, ArrayList<String> objs){
	...
	public Cuadrante clone(){
		...
		return new Cuadrante(this.ID, this.posNW, this.posSE,this.Z, this.conectado, this.objetos);
