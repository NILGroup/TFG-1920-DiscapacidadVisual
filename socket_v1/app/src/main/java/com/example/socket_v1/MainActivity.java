...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //File xmlFile = new File( "C:\\Users\\MRS\\Documents\\Belen\\ucm\\5\\TFG infor\\TFG-1920-DiscapacidadVisual\\socket_v1\\app\\xml\\edificio.xml" );
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button_start_searching:
                startActivity(Client_socket.createIntent(this));
                break;
