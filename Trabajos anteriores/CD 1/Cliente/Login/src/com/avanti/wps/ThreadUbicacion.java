...
import com.avanti.activities.PositionActivity;
import com.avanti.activities.R;
...
//		int numMedidasIncorrectas = 0;
		while(estado != ESTADO_ERROR){
			if(estado == ESTADO_EJECUCION){
				...
				if(!manager.isWifiEnabled()){
					...
					try {
						c = MainMenu.thread.getDatabase().calculatePosition(lista.scanAndShow());							
	 ...
	 * @param c posición devuelta por el algoritmo estándra de posicionamiento
	 * @throws Exception 
	 */
