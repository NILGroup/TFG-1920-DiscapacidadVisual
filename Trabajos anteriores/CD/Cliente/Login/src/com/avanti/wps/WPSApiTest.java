    ...
    implements OnSharedPreferenceChangeListener
{
    ...
    // our Handler understands 2 messages:
    // either a location or an error
                                          ...
                                          String key)
    {
        ...
        else if (key.equals("Local File Path"))
        {
            ...
            _wps.setLocalFilePaths(paths);
        }
        else if (key.equals("Period"))
            _period =
                Long.valueOf(sharedPreferences.getString("Period", "1000"));
