	...
	public static void main(String[] args) {
		...
		while (true) {
			try {
				...
				int posOrigen = ListaCuadrantes.numCuadranteBeacon(beaconOrigen, aCuadrantes);
				...
				int posAct = ListaCuadrantes.numCuadranteBeacon(beaconActual, aCuadrantes);
				...
				if (posDestino != -1) {
					...
					out.writeUTF(ListaCuadrantes.idBeaconCuadrante(gr.getCuadranteClave(), aCuadrantes));
